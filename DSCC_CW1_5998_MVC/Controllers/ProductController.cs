using DSCC_CW1_5998_MVC.Models;
using System;
...
namespace DSCC_CW1_5998_MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        private List<Product> Get()
        {
            try
            {
                ...
                var getDataTask = client.GetAsync("https://localhost:44303/api/product").ContinueWith(response =>
                {
        ...
        public ActionResult Edit(Product product)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri("https://localhost:44303/api/product/" + product.ID);
